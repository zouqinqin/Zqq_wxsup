...
public class UserServiceImpl implements UserService {
	...
	public User findUser(String username, String password) {
		...
		User existUser = this.userMapper.findUser(username,DigestUtils.md5Hex(password));
	 ...
	 */
	@Override
	public UserRoleDTO getUserInfo(String userId){
		UserRoleDTO userRoleDTO = userMapper.getUserInfo(userId);
		return userRoleDTO;
	}
}
